...
import com.innyo.sell.converter.OrderMaster2OrderDTOConverter;
...
import com.innyo.sell.respository.OrderDetailRepository;
import com.innyo.sell.respository.OrderMasterRepository;
 ...
 * @Author: XM
 * @Description:
 * @Data: Create in 2018-04-16 10:46
 * @Modified by:
 */
@Service
@Slf4j
...
//            cartDTOList.add(cartDTO);
    ...
    public OrderDTO finish(OrderDTO orderDTO) {
        ...
        OrderMaster orderMaster = new OrderMaster();
        BeanUtils.copyProperties(orderDTO,orderMaster);
        OrderMaster updateRusult =  orderMasterRepository.save(orderMaster);
        if(updateRusult == null){
