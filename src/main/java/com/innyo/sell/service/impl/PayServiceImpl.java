...
import com.innyo.sell.utils.JsonUtil;
import com.innyo.sell.utils.MathUtil;
 ...
 * @Author: XM
 * @Description:
 * @Data: Create in 2018-04-17 17:40
 * @Modified by:
 */
@Service
@Slf4j
public class PayServiceImpl implements PayService {
    ...
    public PayResponse create(OrderDTO orderDTO) {
        ...
        log.info("【微信支付】 发起支付, reponde={}",JsonUtil.toJson(payResponse));
        return payResponse;
    }
